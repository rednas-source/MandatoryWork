 ...
 * @version 06.09.2023
 *
 * Innlevering 2 for emne INFT 2503 C++
 * Oppgåve 1
 */
#include <iostream>
...
int main() {
    ...
    *p = 7; // nye verdien til i blir 7
    *q += 4; // nye verdien til j blir 9
    *q = *p + 1; // nye verdien til j blir i + 1 som er 7 + 1 som blir 8
    p = q; // adressa til p blir det samme som q, som gjer at p også peiker til j
